...
//    this.results = new Array(_.size(procMap));
//    _.fill(this.results, config.get('strLoading'));
//  }
//
//  update() {
//    _.forIn(this.procMap, (displayAs, process) => {
//      displayAs = displayAs || process;
//      childProcess.spawn('pgrep', ['-x', process]).on('close', (code) => {
//        this._output = code ? util.addBG(displayAs, 'cUrgent') : displayAs;
//      });
//    });
//  }
}
